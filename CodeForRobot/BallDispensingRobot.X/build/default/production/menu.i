...
void setCanisterData(void)
{
    storeCanisterData(Right, 180, 1, 1);
    storeCanisterData(Left, 40, 0, 0);
    storeCanisterData(Right, 420, 1, 0);
    storeCanisterData(Left, 69, 0, 0);
    storeCanisterData(Right, 4, 1, 1);
}
