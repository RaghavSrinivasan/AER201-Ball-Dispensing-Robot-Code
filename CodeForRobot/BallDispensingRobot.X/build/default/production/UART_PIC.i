...
# 36 "UART_PIC.c"
    ...
    TXSTAbits.TXEN = 1; _delay((unsigned long)((5)*(10000000/4000.0)));;
    ...
    while(numTransmits < numBytes){
        ...
        UARTinterruptState = INTCONbits.GIE;
        (INTCONbits.GIE = 0);
        TXREG = data[numTransmits];
        INTCONbits.GIE = UARTinterruptState;
...
void UART_Init(long baud){
# 213 "UART_PIC.c"
    SPBRG = (unsigned char)((10000000 / (64 * baud)) - 1);
