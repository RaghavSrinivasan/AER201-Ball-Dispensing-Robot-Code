...
int shaftEncoderCount(void)
{
    ...
    {
        count[i] = I2C_Master_Read(0);
    }
    count[1] = I2C_Master_Read(1);
    I2C_Master_Stop();
...
float mapDist(int sensor)
{
    int analogRead = distFromCanister(sensor);
    float rval;
    if (sensor == 1)
    {
        rval = 0.0000514*(analogRead)*analogRead - 0.0104*analogRead + 6.33;
    }
    else if (sensor == 2)
    {
        rval = 0.0000463*analogRead*analogRead - 0.0134*analogRead + 6.63;
    }
    return rval;
}
