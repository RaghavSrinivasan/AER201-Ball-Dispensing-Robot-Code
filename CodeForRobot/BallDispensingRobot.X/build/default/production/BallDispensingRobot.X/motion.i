# 1 "BallDispensingRobot.X/motion.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "BallDispensingRobot.X/motion.c" 2
...
# 7 "BallDispensingRobot.X/motion.c" 2
...
void avoidCan(void);
# 8 "BallDispensingRobot.X/motion.c" 2
...
float getTime(void);
# 9 "BallDispensingRobot.X/motion.c" 2
...
_Bool releaseDoor1(void)
{
    ...
    float start = getTime();
    while (readHallEffect() && (getTime() - start) < 0.6)
    {
        LATCbits.LATC5 = 1;
    }
    if ((getTime() - start) > 0.6)
    {
            LATCbits.LATC5 = 0;
            return 0;
    }
...
_Bool releaseDoor2(void)
{
    ...
    while (readHallEffect() == 0 && (getTime() - start) < 0.6)
    {
        LATCbits.LATC5 = 1;
        if (readHallEffect()==1)
        {
