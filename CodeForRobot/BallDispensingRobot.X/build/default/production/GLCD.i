...
static const unsigned char INST_NOP = 0x00;
static const unsigned char INST_SWRESET = 0x01;
static const unsigned char INST_SLPIN = 0x10;
static const unsigned char INST_SLPOUT = 0x11;
static const unsigned char INST_PTLON = 0x12;
static const unsigned char INST_NORON = 0x13;
static const unsigned char INST_INVOFF = 0x20;
static const unsigned char INST_INVON = 0x21;
static const unsigned char INST_GAMSET = 0x26;
static const unsigned char INST_DISPOFF = 0x28;
static const unsigned char INST_DISPON = 0x29;
static const unsigned char INST_CASET = 0x2A;
static const unsigned char INST_RASET = 0x2B;
static const unsigned char INST_RAMWR = 0x2C;
static const unsigned char INST_PTLAR = 0x30;
static const unsigned char INST_TEOFF = 0x34;
static const unsigned char INST_TEON = 0x35;
static const unsigned char INST_MADCTL = 0x36;
static const unsigned char INST_IDMOFF = 0x38;
static const unsigned char INST_IDMON = 0x39;
static const unsigned char INST_COLMOD = 0x3A;
static const unsigned char INST_FRMCTR1 = 0xB1;
static const unsigned char INST_FRMCTR2 = 0xB2;
static const unsigned char INST_FRMCTR3 = 0xB3;
static const unsigned char INST_INVCTR = 0xB4;
static const unsigned char INST_PWCTR1 = 0xC0;
static const unsigned char INST_PWCTR2 = 0xC1;
static const unsigned char INST_PWCTR3 = 0xC2;
static const unsigned char INST_PWCTR4 = 0xC3;
static const unsigned char INST_PWCTR5 = 0xC4;
static const unsigned char INST_VMCTR1 = 0xC5;
static const unsigned char INST_VMOFCTR2 = 0xC7;
# 137 "./GLCD.h"
...
void glcdDrawRectangle(unsigned char XS, unsigned char XE, unsigned char YS, unsigned char YE, unsigned long color);
...
# 58 "GLCD.c"
    ...
    glcdTransfer(INST_CASET, 1);
    glcdTransfer(0x00, 0);
    glcdTransfer(YS, 0);
    glcdTransfer(0x00, 0);
    glcdTransfer(YE - 1, 0);

    glcdTransfer(INST_RAMWR, 1);
    ...
    if((XE == XS) && (YE == YS)){
        ...
        glcdTransfer(color & 0xFF, 0);
        glcdTransfer((color >> 8) & 0xFF, 0);
        glcdTransfer((color >> 16) & 0xFF, 0);
    }
    else{
# 130 "GLCD.c"
...
# 176 "GLCD.c"
    ...
    glcdTransfer(INST_COLMOD, 1);
    glcdTransfer(rawData, 0);
}
...
# 207 "GLCD.c"
    ...
    { glcdTransfer(INST_MADCTL, 1); glcdTransfer(MADCTLbits.reg, 0);};
}
...
# 262 "GLCD.c"
    ...
    { glcdTransfer(INST_SWRESET, 1); _delay((unsigned long)((130)*(10000000/4000.0))); };

    { glcdTransfer(INST_SLPOUT, 1); _delay((unsigned long)((130)*(10000000/4000.0))); };


    glcdTransfer(INST_FRMCTR1, 1);
    glcdTransfer(0x00, 0);
    glcdTransfer(0x06, 0);
    glcdTransfer(0x03, 0);

    glcdTransfer(INST_FRMCTR2, 1);
    glcdTransfer(0x01, 0);
    glcdTransfer(0x2C, 0);
    glcdTransfer(0x2D, 0);

    glcdTransfer(INST_FRMCTR3, 1);
    glcdTransfer(0x01, 0);
    glcdTransfer(0x2C, 0);
    glcdTransfer(0x2D, 0);

    glcdTransfer(INST_INVCTR, 1);
    glcdTransfer(0x00, 0);


    glcdTransfer(INST_PWCTR1, 1);
    glcdTransfer(0xA2, 0);
    glcdTransfer(0x02, 0);
    glcdTransfer(0x84, 0);

    glcdTransfer(INST_PWCTR2, 1);
    glcdTransfer(0xC5, 0);

    glcdTransfer(INST_PWCTR3, 1);
    glcdTransfer(0x0A, 0);
    glcdTransfer(0x00, 0);

    glcdTransfer(INST_PWCTR4, 1);
    glcdTransfer(0x8A, 0);
    glcdTransfer(0x2A, 0);

    glcdTransfer(INST_PWCTR5, 1);
    glcdTransfer(0x8A, 0);
    glcdTransfer(0x2A, 0);


    glcdTransfer(INST_VMCTR1, 1);
    glcdTransfer(0x3C, 0);

    glcdTransfer(INST_INVOFF, 1);
    ...
    glcdTransfer(INST_GAMSET, 1);
    glcdTransfer(0x01, 0);

    glcdTransfer(INST_IDMOFF, 1);

    glcdTransfer(INST_NORON, 1);
